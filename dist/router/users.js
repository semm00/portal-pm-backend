...
const syncUserRecordFromSupabase = async (supabaseUser) => {
    ...
    const fullName = metadata.fullName ??
        metadata.name ??
        email.split("@")[0];
    const desiredUsername = metadata.username ?? email.split("@")[0] ?? email;
...
const buildAuthResponse = (userRecord, session) => {
